    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                <form class="from-group" method="POST" action="/update/traitement">
                    @csrf
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="classe" class="form-control" id="classe" value="{{ $etudiant->classe}}">
                        </div>
